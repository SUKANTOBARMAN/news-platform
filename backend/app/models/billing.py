...
এই মডিউলের টেবিলসমূহ (পূর্ণ কলাম-বিবরণের জন্য দেখো docs/project_documentation_redesigned.pdf, Module 8):
#   - plans
#   - paywall_rules
#   - user_entitlements
#   - subscriptions
...
# TODO: এখানে Billing মডিউলের ক্লাস লেখো
