"""
Module 7 — Content Pivots
SQLAlchemy মডেল এখানে লিখবে (Base, TimestampMixin ইনহেরিট করে)।

STUB — এখানে এখনো কোনো ইমপ্লিমেন্টেশন লেখা হয়নি।


এই মডিউলের টেবিলসমূহ (পূর্ণ কলাম-বিবরণের জন্য দেখো docs/project_documentation_redesigned.pdf, Module 7):
#   - article_category
#   - article_tag
#   - article_topic
#   - article_author
...
# TODO: এখানে ArticlePivot মডিউলের ক্লাস লেখো
